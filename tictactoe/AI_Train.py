"""
Credits: Rohan Patra
Purpose: Train values for AI to use in Reinforcement Learning
Tip: This program will run until you stop it, the longer you run it, the better your AI will become!
Output: The values are automatically saved to trained_state_values_O.txt and trained_state_values_X.txt
"""
import itertools
import random
